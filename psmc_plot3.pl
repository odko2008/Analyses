#!/usr/bin/perl -w
## modified for our bear dataset by Odko
...
print $fh qq(
  ...
  set ylab "$ylab" $afont;
  set out "$prefix.eps";
  set style line 1 lt 1 lc rgb "#000000" $lw;
  set style line 2 lt 1 lc rgb "#808080" $lw;
  set style line 3 lt 1 lc rgb "#87ceeb" $lw;
  set style line 4 lt 1 lc rgb "#bebada" $lw;
  set style line 5 lt 1 lc rgb "#b55700" $lw;
  set style line 6 lt 1 lc rgb "#0000ff" $lw;
  set style line 7 lt 1 lc rgb "#008080" $lw;
  set style line 8 lt 1 lc rgb "#1E90FF" $lw;
  set style line 9 lt 1 lc rgb "#FF00FF" $lw;
  set style line 10 lt 1 lc rgb "#008000" $lw;
  set style line 11 lt 1 lc rgb "#ffa500" $lw;
  set style line 12 lt 1 lc rgb "#FFC0CB" $lw;
