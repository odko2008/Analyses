...
Using the R script; [bear_LEA.R](https://github.com/odko2008/Genome-analyses-for-brown-bears/blob/main/bear_LEA.R), we computed the admixture between the individuals and then visualized the results.
